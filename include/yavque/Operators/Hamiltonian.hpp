...
namespace detail
{
	...
	public:
		...
		[[nodiscard]] Eigen::SparseMatrix<cx_double> get_ham() && { return ham_; }
...
class Hamiltonian final : public Operator
{
private:
...
public:
	...
	[[nodiscard]] const Eigen::MatrixXcd& evecs() const { return p_->evecs(); }

	[[nodiscard]] const Eigen::VectorXd& evals() const { return p_->evals(); }
